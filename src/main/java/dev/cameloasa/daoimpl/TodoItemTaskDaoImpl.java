...
public class TodoItemTaskDaoImpl implements TodoItemTaskDao {
    ...
    private static final String DELETE_SQL =
            "DELETE FROM todo_item_task WHERE task_id = ?";

    private static final String FIND_BY_ID_SQL =
            "SELECT * FROM todo_item_task WHERE task_id = ?";

    private static final String FIND_ALL_SQL =
            "SELECT * FROM todo_item_task";
    ...
    private static final String FIND_BY_DONE_SQL =
            "SELECT * FROM todo_item_task WHERE done = ?";

    private static final String FIND_BY_TITLE_SQL =
            "SELECT * FROM todo_item_task WHERE title LIKE ?";
